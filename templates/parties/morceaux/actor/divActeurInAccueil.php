...
foreach($actors as $actor){
    ...
    <div class="partieActeur<?= $actor['name_actor']?> partieActeurDiv">
        ...
        <div class='partieDroitePres'>
            ...
            <p><?php echo \DatabaseFunction::tronquer($actor['presentation_actor'],120);?></p>
            <div class="contentLien">
            <a href="index.php?controllers=actor&task=showOneSelected&actor=<?php echo htmlspecialchars($actor['id_actor']);?>&user=<?= htmlspecialchars($_SESSION['id']);?>" class='lienActeur'>Lire la suite</a>
            </div>
        </div>
    </div>
<?php
