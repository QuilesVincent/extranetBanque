...
if(empty($_GET['errConnexion']))
                    {?>
                    <form action='index.php?controller=actor&task=showAll' method='post' class='connexionForm'>
                        ...
                        <div class='passwordConnexionContent'>
                            ...
                            <a href='index.php?controller=afficheur&task=afficheResetPassword'>Mot de passe oublié ?</a>
                        </div>
