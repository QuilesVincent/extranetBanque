...
<link href="css/paramUser.css" rel="stylesheet">
        ...
        <body>
            <header class='principalHeader'>
                <h1>Création de vos informations de compte</h1>
            ...
            <div class="divForm">
                ...
                <form action='index.php?controller=actor&task=showBack&user=<?=$idUserSafe ;?>' method='post' class='changeUserFormContent'>
                    ...
                    <div class="secretQuestionAnswerContent">
                        <input type='text' name='secretQuestionAnswerChangeUser' class='answerSecretQuestionChangeUser inputForm' placeholder="Nouvelle réponse à la question selectionnée au-dessus">
                    </div>
                    <button type='submit' name='submitChangeUserFirstConnexion' class='submitChangeUser'>Valider</button>
                </form>
            </div>
